...
public class FileManager {
    ...
    File file = new File(Eco.eco.getDataFolder(), File+".yml");
    ...
    public static void saveconfing(final File File) {
    	 YamlConfiguration cfg = YamlConfiguration.loadConfiguration(File);
    	  try{
              ...
              e.printStackTrace();
              Bukkit.getConsoleSender().sendMessage(SaveStrings.pr+"§cFehler beim Speichern der LocationFile!");
          }
          return;
    }
    ...
    public static double getdouble(final String File,final String name) {
    	File file = new File(Eco.eco.getDataFolder(), File+".yml");
        YamlConfiguration cfg = YamlConfiguration.loadConfiguration(file);
